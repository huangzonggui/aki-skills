...
npx -y bun ./scripts/wechat-browser.ts --markdown source.md --images ./images/ --submit --pre-submit-settings

# Save as draft and skip extra settings (optional troubleshooting)
npx -y bun ./scripts/wechat-browser.ts --markdown source.md --images ./images/ --submit --skip-pre-submit-settings
```
